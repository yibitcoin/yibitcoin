...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("YiBitcoin Core yibitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yibitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yibitcoin transaction") + "\n" +
              "  yibitcoin-tx [options] -create [commands]   " + _("Create hex-encoded yibitcoin transaction") + "\n" +
              "\n";
