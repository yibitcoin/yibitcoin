...
QString BitcoinUnits::name(int unit)
{
    ...
    case kBTC: return QString("kYTC");
    case BTC: return QString("YTC");
    case mBTC: return QString("mYTC");
    case uBTC: return QChar(0x03BC) + QString("YTC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-YiBitcoins (1,000,000)");
    case kBTC: return tr("Kilo-YiBitcoins (1,000)");
    case BTC: return tr("YiBitcoins");
    case mBTC: return tr("Milli-YiBitcoins (1 / 1,000)");
    case uBTC: return tr("Micro-YiBitcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
